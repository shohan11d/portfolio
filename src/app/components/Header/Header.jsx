  ...
  return (<motion.header initial={{ y: -50 }} animate={{ y: 0 }} className="fixed inset-x-0 top-0 w-full p-2 px-5 z-50  backdrop-blur-sm">
    <nav className="flex justify-between  items-center">
      ...
      <ul className='flex gap-3 items-center'>
        ...
        {/* <li>
                <a href="https://github.com/shohan11d" target="_blank" className='group'><span style={{maskImage: `url("/images/github.svg")`}} className="block mx-auto size-[18px] bg-black  dark:bg-white svgMask group-hover:opacity-80 cursor-pointer"></span> </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/shohan11d/"  target="_blank" className='group'><span style={{maskImage: `url("/images/linkedin.svg")`}} className="block mx-auto size-[18px] bg-black  dark:bg-white svgMask group-hover:opacity-80 cursor-pointer"></span> </a>
              </li> */}
